...
class ArrayMultiplierSolution1Test {

    @Test
    void test_multiply_corresponding_elements() {
        int[] array1 = {1, 2, 3};
        int[] array2 = {4, 5, 6};
        int[] result = ArrayMultiplierSolution1.multiplyCorrespondingElements(array1, array2);
    ...
    void test_multiply_with_null_array1() {
        int[] array1 = null;
        int[] array2 = {4, 5, 6};
        assertThatThrownBy(() -> ArrayMultiplierSolution1.multiplyCorrespondingElements(array1, array2))
