...
class ArrayUtilsSolution2Test {
    ...
    void test_remove_target_and_greater_numbers_with_target_in_middle() {
        ...
        int target = 3;
        int[] result = ArrayUtilsSolution2.removeTargetAndGreaterNumbers(array, target);
    ...
    void test_remove_target_and_greater_numbers_with_null_array() {
        int[] array = null;
        assertThatThrownBy(() -> ArrayUtilsSolution2.removeTargetAndGreaterNumbers(array, 3))
    ...
    void test_remove_target_and_greater_numbers_with_empty_array() {
        int[] array = {};
        int[] result = ArrayUtilsSolution2.removeTargetAndGreaterNumbers(array, 3);
        assertThat(result).isEmpty();
    }
