...
class StringUtilsSolution1Test {
    ...
    void test_count_character_occurrences_with_multiple_occurrences() {
        ...
        char character = 'l';
        int result = StringUtilsSolution1.countCharacterOccurrences(sentence, character);
    ...
    void test_count_character_occurrences_with_null_sentence() {
        ...
        char character = 'a';
        assertThatThrownBy(() -> StringUtilsSolution1.countCharacterOccurrences(sentence, character))
