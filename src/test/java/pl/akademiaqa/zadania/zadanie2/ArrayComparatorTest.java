package pl.akademiaqa.zadania.zadanie2;
...
class ArrayComparatorTest {
    ...
    void test_first_and_last_elements_equal() {
        int[] array1 = {1, 2, 3};
        int[] array2 = {1, 4, 3};
        boolean result = ArrayComparator.areFirstAndLastElementsEqual(array1, array2);
    ...
    void test_empty_array1() {
        int[] array1 = {};
        int[] array2 = {1, 4, 3};
        assertThatThrownBy(() -> ArrayComparator.areFirstAndLastElementsEqual(array1, array2))
