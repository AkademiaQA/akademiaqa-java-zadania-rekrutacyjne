...
class StringUtilsSolution2Test {
    ...
    void test_replace_word_with_target_present() {
        ...
        String result = StringUtilsSolution2.replaceWord(sentence, target, replacement);
    ...
    void test_replace_word_with_null_sentence() {
        ...
        String target = "lis";
        String replacement = "kot";
        assertThatThrownBy(() -> StringUtilsSolution2.replaceWord(sentence, target, replacement))
