package pl.akademiaqa.zadania.zadanie22;
...
class ArrayUtilsTest {
    ...
    void test_find_numbers_greater_than_average_with_mixed_values() {
        int[] array = {1, 2, 3, 4, 5};
        List<Integer> result = ArrayUtils.findNumbersGreaterThanAverage(array);
    ...
    void test_find_numbers_greater_than_average_with_empty_array() {
        int[] array = {};
        assertThatThrownBy(() -> ArrayUtils.findNumbersGreaterThanAverage(array))
