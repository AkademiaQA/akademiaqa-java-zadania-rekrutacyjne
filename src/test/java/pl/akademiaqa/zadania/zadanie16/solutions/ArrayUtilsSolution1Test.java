...
class ArrayUtilsSolution1Test {
    ...
    void test_sum_of_every_third_element_equal_to_ten_with_sum_equal_to_ten() {
        ...
        boolean result = ArrayUtilsSolution1.isSumOfEveryThirdElementEqualToTen(array);
    ...
    void test_sum_of_every_third_element_equal_to_ten_with_null_array() {
        int[] array = null;
        assertThatThrownBy(() -> ArrayUtilsSolution1.isSumOfEveryThirdElementEqualToTen(array))
