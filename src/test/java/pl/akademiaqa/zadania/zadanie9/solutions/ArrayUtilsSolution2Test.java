...
class ArrayUtilsSolution2Test {
    ...
    void test_remove_element_present_multiple_times() {
        ...
        int[] result = ArrayUtilsSolution2.removeElement(array, 2);
    ...
    void test_remove_element_present_once() {
        int[] array = {1, 2, 3, 4, 5};
        int[] result = ArrayUtilsSolution2.removeElement(array, 3);
    ...
    void test_remove_element_not_present() {
        int[] array = {1, 2, 3, 4, 5};
        int[] result = ArrayUtilsSolution2.removeElement(array, 6);
    ...
    void test_remove_element_from_empty_array() {
        int[] array = {};
        int[] result = ArrayUtilsSolution2.removeElement(array, 1);
    ...
    void test_remove_element_from_null_array() {
        int[] array = null;
        assertThatThrownBy(() -> ArrayUtilsSolution2.removeElement(array, 1))
