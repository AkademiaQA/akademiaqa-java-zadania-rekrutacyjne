package pl.akademiaqa.zadania.zadanie12;
...
class ArrayUtilsTest {
    ...
    void test_find_common_elements_with_common_chars() {
        char[] array1 = {'a', 'b', 'c', 'd'};
        char[] array2 = {'c', 'd', 'e', 'f'};
        Set<Character> result = ArrayUtils.findCommonElements(array1, array2);
    ...
    void test_find_common_elements_with_null_array1() {
        char[] array1 = null;
        char[] array2 = {'a', 'b', 'c'};
        assertThatThrownBy(() -> ArrayUtils.findCommonElements(array1, array2))
