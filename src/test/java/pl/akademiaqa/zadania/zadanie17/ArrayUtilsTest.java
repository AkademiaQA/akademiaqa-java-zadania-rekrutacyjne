package pl.akademiaqa.zadania.zadanie17;
...
class ArrayUtilsTest {
    ...
    void test_contains_two_elements_with_both_elements_present() {
        int[] array = {1, 2, 3, 4, 5};
        boolean result = ArrayUtils.containsTwoElements(array, 2, 4);
    ...
    void test_contains_two_elements_with_one_element_missing() {
        int[] array = {1, 2, 3, 4, 5};
        boolean result = ArrayUtils.containsTwoElements(array, 2, 6);
    ...
    void test_contains_two_elements_with_both_elements_missing() {
        int[] array = {1, 2, 3, 4, 5};
        boolean result = ArrayUtils.containsTwoElements(array, 6, 7);
        assertThat(result).isFalse();
    }
    ...
    void test_contains_two_elements_with_empty_array() {
        int[] array = {};
        boolean result = ArrayUtils.containsTwoElements(array, 1, 2);
        assertThat(result).isFalse();
    }
    ...
    void test_contains_two_elements_with_null_array() {
        int[] array = null;
        assertThatThrownBy(() -> ArrayUtils.containsTwoElements(array, 1, 2))
